...
localStorage.setItem("username", "neel");
// let storedName = localStorage.getItem("username");


// let jsonData = '{"name":"Neel","age":22}';


// let user = { name: "Neel", age: 22 };
// let jsonString = JSON.stringify(user);
// console.log(jsonString);  // '{"name":"Neel","age":22}'
// let parsedData = JSON.parse(jsonData);
// console.log(parsedData.name); // "Neel"